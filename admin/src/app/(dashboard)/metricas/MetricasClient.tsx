...
import { type MockMetricas, type MockServicio } from '@/lib/mock-data';
...
function ServicesTable({ servicios }: { servicios: MockServicio[] }) {
...
export default function MetricasClient({ metricas, servicios }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
        <KPICard
          ...
          value={String(metricas.servicios_activos)}
        ...
        <KPICard
          title="GMV hoy"
          value={formatSoles(metricas.gmv_hoy)}
        ...
        <KPICard
          ...
          value={String(metricas.agentes_disponibles)}
        ...
        <KPICard
          ...
          value={String(metricas.solicitudes_abiertas)}
        ...
        <KPICard
          ...
          value={String(metricas.disputas_abiertas)}
        ...
        <KPICard
          ...
          value={
            metricas.tiempo_promedio_verificacion
              ? `${metricas.tiempo_promedio_verificacion} min`
              : '—'
          }
